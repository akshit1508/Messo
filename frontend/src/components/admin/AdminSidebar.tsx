...
export function AdminSidebar({ onLogout }: { onLogout: () => void }) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-slate-200 min-h-screen fixed left-0 top-0 bottom-0 z-20">
      {/* Brand Header */}
      ...
      <nav className="flex-1 py-5 px-3 space-y-0.5 overflow-y-auto">
        <p className="px-3 pb-2.5 text-[11px] font-semibold text-slate-400 uppercase tracking-widest">
          Management Console
        </p>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/60 shrink-0">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-amber-100 text-amber-800 font-bold flex items-center justify-center text-sm shrink-0 border border-amber-200">
            {initials}
          </div>
